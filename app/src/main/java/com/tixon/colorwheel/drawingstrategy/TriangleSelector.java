...
public class TriangleSelector extends Drawer implements Strategy {
    @Override
    public void draw(ImageView imageView) {
        ...
        float[] center1 = calculateCoordinates(-60, new float[] {0, 160}, 250, 250);
        float[] center2 = calculateCoordinates(60, new float[] {0, 160}, 250, 250);
