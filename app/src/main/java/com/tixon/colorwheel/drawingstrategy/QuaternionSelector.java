...
public class QuaternionSelector extends Drawer implements Strategy {
    @Override
    public void draw(ImageView imageView) {
        ...
        float[] center2 = calculateCoordinates(90, new float[] {0, 160}, 250, 250);
        float[] center3 = calculateCoordinates(180, new float[] {0, 160}, 250, 250);
        float[] center4 = calculateCoordinates(270, new float[] {0, 160}, 250, 250);
