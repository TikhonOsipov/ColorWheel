...
public class DoubleContrastSelector extends Drawer implements Strategy {
    @Override
    public void draw(ImageView imageView) {
        ...
        float[] center1 = calculateCoordinates(-30, new float[] {0, 160}, 250, 250);
        float[] center2 = calculateCoordinates(30, new float[] {0, 160}, 250, 250);
        float[] center3 = calculateCoordinates(150, new float[] {0, 160}, 250, 250);
        float[] center4 = calculateCoordinates(210, new float[] {0, 160}, 250, 250);
        ...
        oval4.set(center4[0] - 20, center4[1] - 20, center4[0] + 20, center4[1] + 20);
