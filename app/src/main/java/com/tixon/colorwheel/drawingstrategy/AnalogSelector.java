...
public class AnalogSelector extends Drawer implements Strategy {
    @Override
    public void draw(ImageView imageView) {
        ...
        float[] center1 = calculateCoordinates(150, new float[] {0, 160}, 250, 250);
        float[] center2 = calculateCoordinates(180, new float[] {0, 160}, 250, 250);
