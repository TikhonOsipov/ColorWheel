...
import com.tixon.colorwheel.drawingstrategy.TriangleSelector;

public class FragmentTriangleSelector extends AbstractFragment {
    ...
    public FragmentTriangleSelector() {}

    public static Fragment newInstance() {
        FragmentTriangleSelector fragment = new FragmentTriangleSelector();
        Bundle b = new Bundle();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_triangle_selector, container, false);

        drawingContext = new DrawingContext();

        ivWheel = (ImageView) v.findViewById(R.id.ivWheelTriangle);
        ivSelector = (ImageView) v.findViewById(R.id.ivSelectorTriangle);
        ivColor1 = (ImageView) v.findViewById(R.id.ivColor1Triangle);
        ivColor2 = (ImageView) v.findViewById(R.id.ivColor2Triangle);
        ivColor3 = (ImageView) v.findViewById(R.id.ivColor3Triangle);
        ...
        drawingContext.setStrategy(new TriangleSelector());
