...
import com.tixon.colorwheel.drawingstrategy.QuaternionSelector;

public class FragmentQuaternionSelector extends AbstractFragment {
    Matrix matrix;
    ...
    public FragmentQuaternionSelector() {}

    public static Fragment newInstance() {
        FragmentQuaternionSelector fragment = new FragmentQuaternionSelector();
        Bundle b = new Bundle();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_quaternion_selector, container, false);

        drawingContext = new DrawingContext();

        ivWheel = (ImageView) v.findViewById(R.id.ivWheelQuaternion);
        ivSelector = (ImageView) v.findViewById(R.id.ivSelectorQuaternion);
        ivColor1 = (ImageView) v.findViewById(R.id.ivColor1Quaternion);
        ivColor2 = (ImageView) v.findViewById(R.id.ivColor2Quaternion);
        ivColor3 = (ImageView) v.findViewById(R.id.ivColor3Quaternion);
        ivColor4 = (ImageView) v.findViewById(R.id.ivColor4Quaternion);
        ...
        drawingContext.setStrategy(new QuaternionSelector());
