...
import com.tixon.colorwheel.drawingstrategy.ComplementarySelector;
import com.tixon.colorwheel.drawingstrategy.DrawingContext;

public class FragmentComplementarySelector extends AbstractFragment {
    Matrix matrix;
    ...
    public FragmentComplementarySelector() {}

    public static Fragment newInstance() {
        FragmentComplementarySelector fragment = new FragmentComplementarySelector();
        Bundle b = new Bundle();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_complementary_selector, container, false);

        drawingContext = new DrawingContext();

        ivWheel = (ImageView) v.findViewById(R.id.ivWheelComplementary);
        ivSelector = (ImageView) v.findViewById(R.id.ivSelectorComplementary);
        ivColor1 = (ImageView) v.findViewById(R.id.ivColor1Complementary);
        ivColor2 = (ImageView) v.findViewById(R.id.ivColor2Complementary);
        ivColor3 = (ImageView) v.findViewById(R.id.ivColor3Complementary);
        ...
        drawingContext.setStrategy(new ComplementarySelector());
