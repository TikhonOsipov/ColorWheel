...
import com.tixon.colorwheel.drawingstrategy.AlternativeComplementarySelector;
import com.tixon.colorwheel.drawingstrategy.ColorWheel;
import com.tixon.colorwheel.drawingstrategy.DrawingContext;

public class FragmentAltComplementarySelector extends AbstractFragment {
    Matrix matrix;
    ...
    public FragmentAltComplementarySelector() {}

    public static Fragment newInstance() {
        FragmentAltComplementarySelector fragment = new FragmentAltComplementarySelector();
        Bundle b = new Bundle();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_alt_complementary_selector, container, false);

        drawingContext = new DrawingContext();

        ivWheel = (ImageView) v.findViewById(R.id.ivWheelAltComplementary);
        ivSelector = (ImageView) v.findViewById(R.id.ivSelectorAltComplementary);
        ivColor1 = (ImageView) v.findViewById(R.id.ivColor1AltComplementary);
        ivColor2 = (ImageView) v.findViewById(R.id.ivColor2AltComplementary);
        ivColor3 = (ImageView) v.findViewById(R.id.ivColor3AltComplementary);
        ivColor4 = (ImageView) v.findViewById(R.id.ivColor4AltComplementary);
        ...
        drawingContext.setStrategy(new AlternativeComplementarySelector());
